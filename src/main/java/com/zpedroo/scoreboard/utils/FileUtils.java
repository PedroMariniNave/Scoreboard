package com.zpedroo.scoreboard.utils;
...
public class FileUtils {
    ...
    public enum Files {
        ...
        DEFAULT("default", "scoreboards", "scoreboards", true),
        HOLD_ITEM("hold_item", "scoreboards", "scoreboards", true),
        REGION("region", "scoreboards", "scoreboards", true),
        WORLD("world", "scoreboards", "scoreboards", true);
